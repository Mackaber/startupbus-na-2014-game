...
['whatsapp', 'twitter', 'facebook', 'github'].each do |startup_name|
  ...
  team = Team.find_or_create_by \
    description: "#{startup_name} is worth 20 billion dollars",
    facebook_url: "www.facebook.com/#{startup_name}",
    github_url: "www.github.com/#{startup_name}",
    name: startup_name,
    twitter_handle: "@#{startup_name}",
    website: "http://#{startup_name}.com",
    logo_url: "http://#{startup_name}.com/blah.jpg"
